...
export default function ViewCorrectionPage({ application }: ViewCorrectionPageProps) {
  ...
  const handleDownload = async () => {
    ...
    try {
      const response = await fetch(`/api/correction/download-pdf/${application._id}`);
      ...
      a.href = url;
      a.download = `correction-${application.id}.pdf`;
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Application Not Found</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-2">The requested correction application could not be found.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg mb-6">
          <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Correction Application Details</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">View correction information and details</p>
          </div>
          ...
          <div className="px-6 py-4 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-900 dark:text-white">{application.id}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-500 dark:text-gray-400">UBRN</label>
              <p className="mt-1 text-sm text-gray-900 dark:text-white">{application.ubrn}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Date of Birth</label>
              <p className="mt-1 text-sm text-gray-900 dark:text-white">{application.dob}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Correction Information</h2>
            ...
            {application.currectionInfos.map((correction, index) => (
              <div key={correction.id} className="px-6 py-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Field</label>
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Corrected Value</label>
                ...
                <div className="mt-4">
                  <label className="text-sm font-medium text-gray-500 dark:text-gray-400">Correction Cause/Reason</label>
          ...
          {application.currectionInfos.length === 0 && (
            <div className="px-6 py-12 text-center">
              ...
              <h3 className="text-sm font-medium text-gray-900 dark:text-white">No corrections found</h3>
